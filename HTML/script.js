...
//     isDragging = true;
//     e.preventDefault(); // 阻止默认事件，避免选中文本或其他动作
...
//     if (isDragging) {
//         const x = e.pageX;
//         const leftPanelWidth = x;
//         document.querySelector('.left-panel').style.width = `${leftPanelWidth}px`;
//         splitBar.style.left = `${leftPanelWidth-5}px`; // 更新 splitBar 的位置
//     }
// });
