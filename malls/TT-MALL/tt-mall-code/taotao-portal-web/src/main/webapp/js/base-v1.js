 ...
 */
function login() {
    return location.href = "http://mytmall.com:8888/page/login";
}
function regist() {
    return location.href = "http://mytmall.com:8888/page/register";
}
...
function search(a) {
    var b = "http://mytmall.com:8885/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
