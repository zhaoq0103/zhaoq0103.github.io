 ...
 */
function login() {
    return location.href = "http://sso.mytmall.com/page/login";
}
function regist() {
    return location.href = "http://www.mytmall.com/page/register";
}
...
function search(a) {
    var b = "http://search.mytmall.com/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
