...
import com.ai.x.context.ConfigurableApplicationContext;
import com.ai.x.exception.ErrorResponseException;
import com.ai.x.exception.NestedRuntimeException;
import com.ai.x.exception.ServerErrorException;
...
import com.ai.x.utils.PathUtils;
...
public class DispatcherServlet extends HttpServlet {
    ...
    public DispatcherServlet(ApplicationContext applicationContext, PropertyResolver properyResolver) {
        ...
        this.resourcePath = properyResolver.getProperty("${winter.web.static-path:/static/}");
        this.faviconPath = properyResolver.getProperty("${winter.web.favicon-path:/favicon.ico}");
