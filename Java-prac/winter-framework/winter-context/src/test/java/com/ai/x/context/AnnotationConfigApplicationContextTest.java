...
import com.ai.x.imported.LocalDateConfiguration;
import com.ai.x.imported.ZonedDateConfiguration;
import com.ai.x.io.PropertyResolver;
import com.ai.x.scan.convert.ValueConverterBean;
import com.ai.x.scan.custom.annotation.CustomAnnotationBean;
import com.ai.x.scan.init.AnnotationInitBean;
import com.ai.x.scan.init.MyClass;
import com.ai.x.scan.init.SpecifyInitBean;
import com.ai.x.scan.nested.OuterBean;
import com.ai.x.scan.primary.DogBean;
import com.ai.x.scan.primary.PersonBean;
import com.ai.x.scan.primary.StudentBean;
import com.ai.x.scan.primary.TeacherBean;
import com.ai.x.scan.proxy.*;
import com.ai.x.scan.sub1.Sub1Bean;
import com.ai.x.scan.sub1.sub2.Sub2Bean;
import com.ai.x.scan.sub1.sub2.sub3.Sub3Bean;
...
class AnnotationConfigApplicationContextTest {
    ...
    public void testConstructor() {
        var ctx = new AnnotationConfigApplicationContext(ScanApplication.class, createPropertyResolver());
//        getSuitableConstructor 测试一下这个方法， 不确定只实现一个无参构造注入的原因
        assertNull(ctx.findBeanDefinition(MyClass.class));
    }
    ...
    @Test
    public void testPrimaryConfigratrion() {
        var ctx = new AnnotationConfigApplicationContext(ScanApplication.class, createPropertyResolver());
