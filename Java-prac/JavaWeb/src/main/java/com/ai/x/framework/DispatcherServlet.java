...
import com.ai.x.controller.IndexController;
import com.ai.x.controller.UserController;
...
public class DispatcherServlet extends HttpServlet {
    ...
    //List.of(IndexController.class, UserController.class);
    ...
    private static final Set<Class<?>> supportedGetParameterTypes = new HashSet<Class<?>>(){
        {
            add(int.class);add(long.class);add(boolean.class);add(String.class);
            add(HttpServletRequest.class);add(HttpServletResponse.class);add(HttpSession.class);
        }
    };
