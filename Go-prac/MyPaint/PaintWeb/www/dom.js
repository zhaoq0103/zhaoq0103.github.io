...
class QSerializer {
    ...
    create(json) {
        ...
        console.log("unsupport shape: " + JSON.stringify(json))
        return null
    }
}
...
function callAsync(method, url, headers, body, onOK) {
    ...
    let doFunc = function() {
        ...
        http.setRequestHeader("Authorization", "QPaintStub 9527")
...
class QShapeStyle {
  ...
  setProp(key, val) {
    console.log("QShapeStyle setProp key: " + key + " val:" + val)
