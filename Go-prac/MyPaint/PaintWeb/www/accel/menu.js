...
function selection_setProp(key, val) {
        // console.log("selection_setProp1 key: " + key + "  val:" + val)
    if (qview.selection != null) {
        // console.log("selection_setProp2 key: " + key + "  val:" + val)
...
function onSelectionChanged(old) {
    ...
    if (selection != null) {
        console.log("selectionon   SelectionChanged ")
